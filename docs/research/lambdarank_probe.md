...
realistically beat the current default `TechnicalScore 0.852704` without paid
API calls.
...
|---|---:|---|
| Current default score to beat | 0.852704 | Baseline remains stronger. |
...
|---|---|
| No trained model benchmark beat `0.852704`. | The project rule says we only submit the best measured method. |
...
TechnicalScore above `0.852704`, keeps HitRate@10 at least `0.960000`, and has
acceptable latency.
