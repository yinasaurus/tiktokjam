...
realistically beat the current default `TechnicalScore 0.902564` without paid
API calls.
...
|---|---:|---|
| Current default score to beat | 0.902564 | Rank tie-break PR remains stronger. |
...
|---|---|
| No trained model benchmark beat `0.902564`. | The project rule says we only submit the best measured method. |
...
TechnicalScore above `0.902564`, keeps HitRate@10 at least `1.000000`, and has
acceptable latency.
