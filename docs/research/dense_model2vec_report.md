...
ready to prove it can beat the current clean TechnicalScore of `0.955300`.
...
| Result | Decision |
|---|---|
| Full public-set TechnicalScore beats `0.955300`, with HR@10 not lower and acceptable latency | Consider merging dense path. |
